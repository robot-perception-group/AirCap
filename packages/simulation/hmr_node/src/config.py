...
DATASET_NPZ_PATH = aircaprl_path+'/git/SPIN/data/dataset_extras'
...
CUBE_PARTS_FILE = aircaprl_path+'/git/SPIN/data/cube_parts.npy'
JOINT_REGRESSOR_TRAIN_EXTRA = aircaprl_path+'/git/SPIN/data/J_regressor_extra.npy'
JOINT_REGRESSOR_H36M = aircaprl_path+'/git/SPIN/data/J_regressor_h36m.npy'
VERTEX_TEXTURE_FILE = aircaprl_path+'/git/SPIN/data/vertex_texture.npy'
STATIC_FITS_DIR = aircaprl_path+'/git/SPIN/data/static_fits'
SMPL_MEAN_PARAMS = aircaprl_path+'/git/SPIN/data/smpl_mean_params.npz'
SMPL_MODEL_DIR = aircaprl_path+'/git/SPIN/data/smpl'
