...
ALG = "/ppo2_mlp_aamas"
task_and_robot_environment_name = 'DeepFollow-v7'#rospy.get_param('task_and_robot_environment_name')
...
if __name__ == "__main__":
    ...
    model = PPO2(MLPPolicyGT, env, verbose=1,tensorboard_log=log_dir)
    ...
    if prediction_only=='True':
        ...
        model.learn(total_timesteps=3000000,tb_log_name = log_dir,callback = callback)
